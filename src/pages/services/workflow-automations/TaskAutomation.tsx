...
import { Workflow, CheckCircle, Bot } from "lucide-react";

const TaskAutomation = () => {
  return (
    <SubcategoryTemplate
      serviceTitle="Workflow Automations"
      serviceIcon={Workflow}
      subcategoryTitle="Task Automation"
      subcategoryIcon={CheckCircle}
      description="Eliminating repetitive tasks with intelligent automation"
      mainServicePath="/services/workflow-automations"
      content={
